...
- (instancetype)initWithSignal:(NSMutableArray<XFWDouble *> *)signal augmentedLead:(int32_t)augmentedLead applyFilter:(BOOL)applyFilter adjustRPeaks:(BOOL)adjustRPeaks data:(XFWKotlinDoubleArray *)data __attribute__((swift_name("init(signal:augmentedLead:applyFilter:adjustRPeaks:data:)"))) __attribute__((objc_designated_initializer));
...
- (XFWEcgProcessorResult *)processAugmentedLeadGenerator:(XFWAugmentedLeadGenerator * _Nullable)augmentedLeadGenerator age:(int32_t)age data:(XFWKotlinDoubleArray *)data __attribute__((swift_name("process(augmentedLeadGenerator:age:data:)")));
@end;
